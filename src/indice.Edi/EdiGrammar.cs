...
public class EdiGrammar : IEdiGrammar
{
    ...
    public void SetAdvice(char segmentNameDelimiter,
        ...
        Reserved = reserved.HasValue ? [reserved.Value] : [];
    ...
    public static IEdiGrammar NewEdiFact() => new EdiGrammar();

    /// <summary>
    /// Factory for creating an <see cref="IEdiGrammar"/> with the Trandacoms defaults.
    /// </summary>
    /// <returns>The <see cref="IEdiGrammar"/></returns>
    public static IEdiGrammar NewTradacoms() => new EdiGrammar() {
        SegmentNameDelimiter = '=',
        ComponentDataElementSeparator = ':',
        DataElementSeparator = '+',
        DecimalMark = null,
    ...
    /// </summary>
    /// <returns>The <see cref="IEdiGrammar"/></returns>
    public static IEdiGrammar NewX12() => new EdiGrammar() {
        SegmentNameDelimiter = '*',
        ComponentDataElementSeparator = '>',
        DataElementSeparator = '*',
        DecimalMark = '.',
    ...
    public EdiGrammar Clone() => new EdiGrammar(this);
}
