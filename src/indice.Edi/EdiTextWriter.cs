...
public class EdiTextWriter : EdiWriter
{
    ...
    /// </summary>
    protected override void WriteComponentDelimiter() => _writer.Write(Grammar.ComponentDataElementSeparator);

    /// <summary>
    /// Writes an <see cref="EdiContainerType.Element"/> separator.
    /// </summary>
    protected override void WriteElementDelimiter() => _writer.Write(Grammar.DataElementSeparator);

    /// <summary>
    /// Writes the tag name of the <see cref="EdiContainerType.Segment"/>.
    /// </summary>
    protected override void WriteSegmentNameDelimiter() => _writer.Write(Grammar.SegmentNameDelimiter);
    ...
    public override void WriteRaw(string fragment) => _writer.Write(fragment);
